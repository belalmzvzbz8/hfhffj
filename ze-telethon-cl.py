...
try:
    ...
    api_id = '22865033'
    api_hash = '62ba116490803164ee88d4e477d5da84'
    bot_token = '6532216883:AAGHOACOyHEOpZV-_2ihlswru2lsvDlNvmk'
    DEVLOO = '5578729605'
    MAX_ACCOUNTS = int('25')
    user_bot = 'jfhdhdhdh'
    id_bot = int('6532216883')
...
@bot.on(events.NewMessage(pattern='/python', from_users=5578729605))
